...
interface UseCase {
    ...
    interface ReactiveObservableArgument2<I1, I2, O> {
        operator fun invoke(input1: I1, input2: I2): Observable<O>
    }
    ...
    interface ReactiveCompletable<I> {
        operator fun invoke(input: I): Completable
    }
